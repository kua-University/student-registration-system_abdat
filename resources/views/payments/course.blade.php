...
<body class="bg-gray-900 text-white font-sans antialiased">
    <div class="container mx-auto py-12">
        ...
        <h1 class="text-3xl font-bold text-indigo-500 mb-2">Payment for {{ $course->name }}</h1>
        ...
        <form id="payment-form" class="space-y-6">
            ...
            <!-- Submit Button -->
            <button id="submit" class="w-full px-4 py-3 bg-black-500 text-white font-semibold rounded-lg shadow-lg hover:bg-indigo-600 transition duration-300">
                Pay ${{ number_format($fee / 2, 2) }}
            </button>
